...
-(void)SetCameraSession {
    if ([self captureManager] == nil) {
		...
		if ([[self captureManager] setupSession:NO]) {
            ...
            if(IS_IPHONE_5)
                [newCaptureVideoPreviewLayer setFrame:CGRectMake(0, 55, [HelperMethod GetDeviceWidth], [HelperMethod GetDeviceWidth] * (4.0f/3.0f))];
            else if (IS_IPHONE)
                [newCaptureVideoPreviewLayer setFrame:CGRectMake(0, 10, [HelperMethod GetDeviceWidth], [HelperMethod GetDeviceWidth] * (4.0f/3.0f))];
